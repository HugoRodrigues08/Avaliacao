...
namespace escola.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Sobrenome,DataCadatro,Turma")] Alunos alunos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Sobrenome,DataCadatro,Turma")] Alunos alunos)
        {
            if (id != alunos.Id)
            {
                return NotFound();
